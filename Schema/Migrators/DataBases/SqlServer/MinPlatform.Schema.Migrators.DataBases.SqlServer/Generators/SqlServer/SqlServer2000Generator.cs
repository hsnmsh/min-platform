...
using MinPlatform.Schema.Migrators.DataBases.SqlServer.SqlServer;
...
namespace MinPlatform.Schema.Migrators.DataBases.SqlServer.Generators.SqlServer
{
    ...
    {
        public SqlServer2000Generator(IConnectionStringAccessor connectionStringAccessor)
            : this(new SqlServer2000Quoter(), connectionStringAccessor)
        {
        }
        ...
        public SqlServer2000Generator(
            ...
            : this(quoter, new GeneratorOptions(), connectionStringAccessor)
        {
        }
        ...
        public SqlServer2000Generator(
            ...
            IConnectionStringAccessor connectionStringAccessor)
            : this(new SqlServer2000Column(new SqlServer2000TypeMap(), quoter), quoter, new EmptyDescriptionGenerator(), generatorOptions, connectionStringAccessor)
        {
        }
        ...
        public override string Generate(CreateDataBaseExpression expression)
        {
            var queryBuilder = new StringBuilder();
            var builder = new SqlConnectionStringBuilder(ConnectionStringAccessor.ConnectionString);

            queryBuilder
                .AppendFormat(CreateDataBase, builder.InitialCatalog);

            return queryBuilder.ToString();
        }

        public override string Generate(DeleteDataBaseExpression expression)
        {
            var queryBuilder = new StringBuilder();
            var builder = new SqlConnectionStringBuilder(ConnectionStringAccessor.ConnectionString);

            queryBuilder
                .AppendFormat(DropDataBase, builder.InitialCatalog);
