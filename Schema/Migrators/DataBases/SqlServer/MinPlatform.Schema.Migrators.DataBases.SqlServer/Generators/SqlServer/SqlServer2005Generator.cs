...
namespace MinPlatform.Schema.Migrators.DataBases.SqlServer.Generators.SqlServer
{
    ...
    public class SqlServer2005Generator : SqlServer2000Generator
    {
        ...
        public SqlServer2005Generator(IConnectionStringAccessor connectionStringAccessor)
            : this(new SqlServer2005Quoter(), connectionStringAccessor)
        {
        }

        public SqlServer2005Generator(
            [NotNull] SqlServer2005Quoter quoter, IConnectionStringAccessor connectionStringAccessor)
