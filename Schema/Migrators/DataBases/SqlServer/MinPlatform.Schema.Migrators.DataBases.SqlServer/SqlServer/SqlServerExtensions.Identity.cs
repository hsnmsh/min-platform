...
namespace MinPlatform.Schema.Migrators.DataBases.SqlServer.SqlServer
{
    ...
    public static partial class SqlServerExtensions
    {
        ...
        public static TNext Identity<TNext, TNextFk>(
            ...
            int seed,
            int increment)
            where TNext : ISchemaMigratorSyntax where TNextFk : ISchemaMigratorSyntax
        {
        ...
        private static ISupportAdditionalFeatures GetColumn<TNext, TNextFk>(IColumnOptionSyntax<TNext, TNextFk> expression) where TNext : ISchemaMigratorSyntax where TNextFk : ISchemaMigratorSyntax
        {
