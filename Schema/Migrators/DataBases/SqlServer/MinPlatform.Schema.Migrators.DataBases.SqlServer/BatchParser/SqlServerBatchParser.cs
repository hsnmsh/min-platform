...
namespace MinPlatform.Schema.Migrators.DataBases.SqlServer.BatchParser
{
    using System.Collections.Generic;
    using JetBrains.Annotations;
    using MinPlatform.Schema.Migrators.Runner.BatchParser;
    using MinPlatform.Schema.Migrators.Runner.BatchParser.RangeSearchers;
