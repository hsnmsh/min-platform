...
namespace MinPlatform.Schema.Migrators
{
    ...
    /// <para>The behavior may be overriden by providing a custom <c>MinPlatform.Schema.Migrators.Abstractions.Runner.Conventions.IAutoNameConvention</c>.</para>
    /// </remarks>
    public abstract class AutoScriptMigration : MigrationBase
    {
        ...
        [CanBeNull]
        private IReadOnlyCollection<IEmbeddedResourceProvider> providers;
        ...
        private IReadOnlyCollection<IEmbeddedResourceProvider> GetProviders()
        {
            ...
            {
                return this.providers = embeddedResourceProviders;
            }
