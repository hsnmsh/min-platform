...
namespace MinPlatform.Schema.Migrators.Builders.Alter.Table
{
    using System;
                                               ...
                                               IColumnExpressionBuilder
    {
        ...
        public void ToSchema(string schemaName)
        {
            ...
            context.Expressions.Add(alterSchema);
        }
        ...
        public IAlterTableColumnAsTypeSyntax AddColumn(string name)
        {
            ...
            context.Expressions.Add(createColumn);
            return this;
        }
        ...
        public IAlterTableColumnAsTypeSyntax AlterColumn(string name)
        {
            ...
            context.Expressions.Add(alterColumn);
            return this;
        }
