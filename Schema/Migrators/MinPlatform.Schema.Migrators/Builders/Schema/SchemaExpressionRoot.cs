...
namespace MinPlatform.Schema.Migrators.Builders.Schema
{
    ...
    using MinPlatform.Schema.Migrators.Builders.Schema.Schema;
    ...
    public class SchemaExpressionRoot : ISchemaExpressionRoot
    {
        ...
        {
            return new SchemaTableQuery(context, null, tableName);
        }

        /// <inheritdoc />
        public ISchemaSchemaSyntax Schema(string schemaName)
        {
            return new SchemaSchemaQuery(context, schemaName);
        }

        /// <inheritdoc />
        public ISchemaSequenceSyntax Sequence(string sequenceName)
        {
            return new SchemaSequenceQuery(context, null, sequenceName);
        }
    }
}
