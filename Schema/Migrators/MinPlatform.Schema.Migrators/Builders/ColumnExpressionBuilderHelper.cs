...
namespace MinPlatform.Schema.Migrators.Builders
{
    ...
    {
        private readonly Dictionary<ColumnDefinition, ExistingRowsData> existingRowsDataByColumn;
        private readonly IColumnExpressionBuilder builder;
        ...
        public ColumnExpressionBuilderHelper(IColumnExpressionBuilder builder, IMigrationContext context)
        {
            ...
            existingRowsDataByColumn = new Dictionary<ColumnDefinition, ExistingRowsData>();
        }
        ...
        public virtual void SetNullable(bool isNullable)
        {
            ...
            if (existingRowsDataByColumn.TryGetValue(column, out exRowExpr))
            {
                if (exRowExpr.SetExistingRowsExpression != null)
                {
                    if (isNullable)
                    {
                        ...
                        context.Expressions.Remove(exRowExpr.SetColumnNotNullableExpression);
                    ...
                    else
                    {
                        ...
                        if (exRowExpr.SetColumnNotNullableExpression == null)
                        {
                            ...
                            context.Expressions.Add(exRowExpr.SetColumnNotNullableExpression);
                        }
                    }
        ...
        public virtual void SetExistingRowsTo(object existingRowValue)
        {
            ...
            if (column.ModificationType == ColumnModificationType.Create)
            {
                ...
                if (!existingRowsDataByColumn.TryGetValue(column, out exRowExpr))
                {
                    ...
                    existingRowsDataByColumn.Add(column, exRowExpr);
                }
                ...
                if (exRowExpr.SetExistingRowsExpression == null)
                {
                    ...
                    context.Expressions.Add(exRowExpr.SetExistingRowsExpression);
