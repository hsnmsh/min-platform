...
namespace MinPlatform.Schema.Migrators.Runner.VersionTableInfo
{
    ...
    {
        public DefaultVersionTableMetaData(IConventionSet conventionSet, RunnerOptions runnerOptions)
        {
