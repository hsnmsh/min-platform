...
namespace MinPlatform.Schema.Migrators.Runner.Processors
{
    ...
    public class SelectingProcessorAccessor : IProcessorAccessor
    {
        public SelectingProcessorAccessor(
            ...
            SelectingProcessorAccessorOptions options,
            SelectingGeneratorAccessorOptions generatorSelectorOptions,
            IConnectionStringAccessor connectionStringAccessor,
            ProcessorOptions processorOptions)
        {
            var procs = processors.ToList();

            var processorId = string.IsNullOrEmpty(options.ProcessorId)
                ? generatorSelectorOptions.GeneratorId
                : options.ProcessorId;
