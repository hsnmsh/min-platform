...
namespace MinPlatform.Schema.Migrators.Runner.Conventions
{
    ...
    {
        private readonly IDefaultSchemaNameConvention defaultSchemaNameConvention;
        ...
        {
            this.defaultSchemaNameConvention = defaultSchemaNameConvention;
        }
        ...
        {
            return defaultSchemaNameConvention.GetSchemaName(originalSchemaName);
        }
