...
namespace MinPlatform.Schema.Migrators.Runner.Core.Extensions
{
    ...
    /// </summary>
    public static class SchemaMigratorServiceCollectionExtensions
    {
        /// <summary>
        ...
        [NotNull]
        public static IServiceCollection AddSchemaMigratorCore(
            [NotNull] this IServiceCollection services)
        {
            ...
            // Add logging support
            services.AddSerilogSystemLoggerFactory();
...
#pragma warning restore 618
            ...
            services
                .TryAddScoped(sp => sp.GetRequiredService<ProcessorOptions>());
...
#pragma warning restore 612
            ...
            services.AddScoped<ISchemaBuilderMigratorEngine, SchemaBuilderMigratorEngine>();
            services.AddTransient<SchemaBuilderManager>();
        ...
        public static IServiceCollection ConfigureRunner(
            [NotNull] this IServiceCollection services,
            [NotNull] Action<IMigrationRunnerBuilder<IServiceCollection>> configure)
        {
        ...
        private class MigrationRunnerBuilder : IMigrationRunnerBuilder<IServiceCollection>
        {
