...
namespace MinPlatform.Schema.Migrators.Runner.Generators.Base
{
    ...
    public abstract class GeneratorBase : IMigrationGenerator
    {
        ...
        protected readonly IConnectionStringAccessor ConnectionStringAccessor;
        ...
        )
        {
            ...
            ConnectionStringAccessor = connectionStringAccessor;
        }

        public abstract string Generate(CreateDataBaseExpression expression);
        public abstract string Generate(DeleteDataBaseExpression expression);
        ...
        {
            get { return descriptionGenerator; }
        }
    }
}
