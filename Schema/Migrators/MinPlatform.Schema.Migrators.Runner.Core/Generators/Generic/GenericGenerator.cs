namespace MinPlatform.Schema.Migrators.Runner.Generators.Generic
{
    using System;
    using System.Collections.Generic;
    using System.Linq;
    using System.Text;
    using MinPlatform.Schema.Migrators.Runner.Generators.Base;
    ...
    public abstract class GenericGenerator : GeneratorBase
    {
        protected GenericGenerator(
            ...
            : base(column, quoter, descriptionGenerator, connectionStringAccessor)
        {
        ...
        public virtual string CreateDataBase { get { return "IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = '{0}')\r\n  BEGIN CREATE DATABASE {0} END"; } }
        ...
        public virtual string DropDataBase { get { return "DROP DATABASE IF EXISTS {0};"; } }
