...
namespace MinPlatform.Schema.Migrators.Runner.BatchParser
{
    ...
    public class SqlBatchParser
    {
        [NotNull]
        [ItemNotNull]
        private readonly IEnumerable<IRangeSearcher> rangeSearchers;

        [NotNull]
        [ItemNotNull]
        private readonly IEnumerable<ISpecialTokenSearcher> specialTokenSearchers;
        ...
        public SqlBatchParser(
            ...
            string newLine = null)
        {
            this.rangeSearchers = rangeSearchers;
            this.specialTokenSearchers = specialTokenSearchers;
        ...
        public void Process(ITextSource source, bool stripComments = false)
        {
            ...
            var context = new SearchContext(rangeSearchers, specialTokenSearchers, stripComments);
