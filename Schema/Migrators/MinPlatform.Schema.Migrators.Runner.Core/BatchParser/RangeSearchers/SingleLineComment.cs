...
namespace MinPlatform.Schema.Migrators.Runner.BatchParser.RangeSearchers
{
    ...
    {
        private readonly bool onlyAtBeginningOfLine;
        ...
        {
            this.onlyAtBeginningOfLine = onlyAtBeginningOfLine;
            startCodeRegex = new Regex(Regex.Escape(startCode), RegexOptions.CultureInvariant | RegexOptions.Compiled);
