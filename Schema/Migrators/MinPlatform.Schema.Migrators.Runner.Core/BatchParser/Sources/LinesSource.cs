...
namespace MinPlatform.Schema.Migrators.Runner.BatchParser.Sources
{
    using System;
    ...
    {
        [NotNull, ItemNotNull]
        private readonly IEnumerable<string> batchSource;
        ...
        {
            var enumerator = batchSource.GetEnumerator();
