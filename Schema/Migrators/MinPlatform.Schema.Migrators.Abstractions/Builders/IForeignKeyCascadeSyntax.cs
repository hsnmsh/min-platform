...
namespace MinPlatform.Schema.Migrators.Abstractions.Builders
{
    ...
    public interface IForeignKeyCascadeSyntax<TNext, TNextFk> : ISchemaMigratorSyntax
        where TNext : ISchemaMigratorSyntax
        where TNextFk : ISchemaMigratorSyntax
    {
        /// <summary>
