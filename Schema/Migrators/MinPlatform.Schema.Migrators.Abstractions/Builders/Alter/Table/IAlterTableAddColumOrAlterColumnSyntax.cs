...
namespace MinPlatform.Schema.Migrators.Abstractions.Builders.Alter.Table
{
    ...
    /// </summary>
    public interface IAlterTableAddColumnOrAlterColumnSyntax : ISchemaMigratorSyntax
    {
        /// <summary>
        /// Add a column
        /// </summary>
