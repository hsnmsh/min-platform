...
namespace MinPlatform.Schema.Migrators.Abstractions.Builders.Delete.ForeignKey
{
    ...
    /// </summary>
    public interface IDeleteForeignKeyForeignColumnSyntax : ISchemaMigratorSyntax
    {
        /// <summary>
