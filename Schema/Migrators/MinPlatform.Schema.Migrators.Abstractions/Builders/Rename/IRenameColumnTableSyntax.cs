...
namespace MinPlatform.Schema.Migrators.Abstractions.Builders.Rename
{
    using MinPlatform.Schema.Migrators.Abstractions.Builders.Rename.Column;
    using MinPlatform.Schema.Migrators.Abstractions.Infrastructure;

    /// <summary>
    /// Specify the table (or its column) to be renamed
    /// </summary>
    public interface IRenameColumnTableSyntax : ISchemaMigratorSyntax
    {
        /// <summary>
