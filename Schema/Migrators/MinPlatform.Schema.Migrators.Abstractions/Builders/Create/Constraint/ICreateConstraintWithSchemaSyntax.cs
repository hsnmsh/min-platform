...
namespace MinPlatform.Schema.Migrators.Abstractions.Builders.Create.Constraint
{
    ...
    /// </summary>
    public interface ICreateConstraintWithSchemaSyntax : ISchemaMigratorSyntax
    {
        /// <summary>
