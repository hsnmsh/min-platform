...
namespace MinPlatform.Schema.Migrators.Abstractions.Builders.Create
{
    ...
    /// </summary>
    public interface ICreateExpressionRoot : ISchemaMigratorSyntax
    {
        ICreateDataBaseSyntax DataBase();
