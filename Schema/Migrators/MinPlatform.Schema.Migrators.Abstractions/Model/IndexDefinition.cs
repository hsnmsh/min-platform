...
namespace MinPlatform.Schema.Migrators.Abstractions.Model
{
    using System;
    ...
    public class IndexDefinition
        : ICloneable,
          ...
          IValidationChildren
    {
        private readonly IDictionary<string, object> additionalFeatures = new Dictionary<string, object>();
        ...
        /// <inheritdoc />
        public virtual IDictionary<string, object> AdditionalFeatures => additionalFeatures;
