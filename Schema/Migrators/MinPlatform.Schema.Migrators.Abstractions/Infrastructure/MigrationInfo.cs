...
namespace MinPlatform.Schema.Migrators.Abstractions.Infrastructure
{
    using System;
    ...
    {
        private readonly Dictionary<string, object> traits = new Dictionary<string, object>();
        ...
        {
            return traits.ContainsKey(name) ? traits[name] : null;
        }
