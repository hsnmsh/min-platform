...
namespace MinPlatform.Schema.Migrators.Abstractions
{
    using System;
    ...
    public class TimestampedMigrationAttribute : MigrationAttribute
    {
        ...
        /// <param name="hour">The hour the migration was created.</param>
        /// <param name="minute">The minute the migration was created.</param>
        /// <param name="transactionBehavior">The <see cref="MinPlatform.Schema.Migrators.Abstractions.TransactionBehavior"/> the migration will use.</param>
