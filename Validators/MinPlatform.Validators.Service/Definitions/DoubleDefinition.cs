namespace MinPlatform.Validators.Service.Definitions
{
    ...
    public sealed class DoubleDefinition : NumericDefinition
    {
        internal override string DefinitionName => "double";
        ...
        internal override ValidationCheckResult CheckValidatorsPerDefinition(object value)
        {
            ...
            foreach (IValidator<double> validator in Validators)
            {
                var validatonResult = validator.IsValid(this, (double)value);
