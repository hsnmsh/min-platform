namespace MinPlatform.Validators.Service.Definitions
{
    ...
    public sealed class EnumDefinition : BaseDefinition
    {
        internal override string DefinitionName => "enum";
        ...
        internal override ValidationCheckResult CheckValidatorsPerDefinition(object value)
        {
            ...
            foreach (IValidator<Enum> validator in Validators)
            {
                var validatonResult = validator.IsValid(this, (Enum)value);
