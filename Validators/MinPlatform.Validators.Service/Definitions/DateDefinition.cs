namespace MinPlatform.Validators.Service.Definitions
{
    ...
    public sealed class DateDefinition : BaseDefinition
    {
        internal override string DefinitionName => "date";
        ...
        internal override ValidationCheckResult CheckValidatorsPerDefinition(object value)
        {
            ...
            foreach (IValidator<DateTime> validator in Validators)
            {
                var validatonResult = validator.IsValid(this, (DateTime)value);
