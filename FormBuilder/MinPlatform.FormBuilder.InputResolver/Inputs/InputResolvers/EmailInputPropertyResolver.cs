namespace MinPlatform.FormBuilder.Elements.Inputs.InputResolvers
{
    ...
    internal sealed class EmailInputPropertyResolver : BaseInputPropertyResolver<EmailPropertyInput, EmailInputType>
    {
        public EmailInputPropertyResolver(EmailPropertyInput propertyInputType,
        ...
        public async override Task<EmailInputType> ResolveInputAsync()
        {
            await SetCommonPropertiesAsync();

            return new EmailInputType
            {
                InputType = InputType.Email.ToString().ToLower(),
                ...
                AllowedDomains = PropertyInputType.AllowedDomains
            };
        }
    }
}
