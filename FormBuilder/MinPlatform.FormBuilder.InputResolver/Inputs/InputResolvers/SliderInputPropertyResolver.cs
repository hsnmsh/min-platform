namespace MinPlatform.FormBuilder.Elements.Inputs.InputResolvers
{
    ...
    internal sealed class SliderInputPropertyResolver : BaseInputPropertyResolver<SliderPropertyInput, SliderInputType>
    {
        public SliderInputPropertyResolver(SliderPropertyInput propertyInputType,
        ...
        public async override Task<SliderInputType> ResolveInputAsync()
        {
            await SetCommonPropertiesAsync();

            return new SliderInputType
            {
                InputType = InputType.Slider.ToString().ToLower(),
